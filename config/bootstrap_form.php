...
return [
    ...
    /* It's necessary to include this, even though it's the default value, because otherwise setting the template to
     * bootstrap_currency_form.php and then back to bootstrap_form.php results in 'formGroup' not being changed back. */
